import { FinanceTalentCommissionService } from '../../service/talentCommission';
import { FinanceTalentCommissionEntity } from '../../entity/talentCommission';
import { FinanceTalentCommissionQueryDTO } from '../../dto/talentCommission'; // Assume a DTO is defined
...
@CoolController({
  ...
  service: FinanceTalentCommissionService,
})
export class OpenFinanceTalentCommissionController extends BaseController {
  // @InjectEntityModel(FinanceTalentCommissionEntity)
  // financeTalentCommissionEntity: Repository<FinanceTalentCommissionEntity>;

  // @Inject()
  // ctx: Context; // 注入上下文对象

  // @Inject()
  // financeTalentCommissionService: FinanceTalentCommissionService;

  // /**
  //  * Get paginated list of talent commission records
  //  */
  // @Get('/commission-list')
  // @Validate()
  // async commissionList(@Query() query: FinanceTalentCommissionQueryDTO) {
  //   const result = await this.financeTalentCommissionService.list(query);
  //   return {
  //     code: 200,
  //     message: 'Success',
  //     data: result,
  ...
  // /**
  //  * Export talent commission records to Excel
  //  */
  // @Get('/export')
  // @Validate()
  // async export(@Query() query: FinanceTalentCommissionQueryDTO) {
  //   const { headers, data } = await this.financeTalentCommissionService.export(query);
  ...
  // /**
  //  * Import talent commission records from Excel
  //  */
  // @Post('/import')
  ...
  //     const result = await this.financeTalentCommissionService.import(data);
